...
export default function SubsriptionCard({
    ...
    return (
        <>
            {!isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-black w-[300px] h-[max-content] shadow-slate-400 shadow-2xl">
